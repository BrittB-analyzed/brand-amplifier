...
const caseTeasers = [
  {
    ...
    metric: { before: "0%", after: "85%", label: "Prompts waarin merk wordt genoemd" },
  },
  {
    slug: "vogelvoerkopen",
    sector: "E-commerce",
...
const services = [
  ...
  { to: "/diensten/cro", label: "CRO", color: "blue" as const, desc: "Converterende funnels die van elke AI-lead een betalende klant maken.", icon: CroIcon },
];
    ...
    <>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <SectionHeader
            eyebrow="Diensten"
            title="Specialistische focus, één onderbouwde aanpak"
            description="SEO eerst, dan GEO naar SEA + AI ads en dan CRO."
            align="center"
            className="mb-16"
          />
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <ul className="space-y-4">
                  {[
                    ...
                    "Je eigen vaste aanspreekpunt.",
                    "Dagelijks antwoord via je eigen kanaal.",
                    "Maatwerk: betaal alleen voor wat werkt.",
                  ].map((t) => (
                ...
                <div className="bg-molten/5 p-6 rounded-[16px] ring-1 ring-molten/10">
                  ...
                  <ul className="text-sm space-y-3 mb-6 text-twilight">
                    ...
                    <li className="flex items-start gap-2"><Check className="size-4 text-molten shrink-0 mt-0.5" /> Gratis concurrentie-analyse</li>
          ...
          <div className="grid lg:grid-cols-3 gap-12 mb-16">
            <div className="lg:col-span-2">
              <SectionHeader
                ...
                description="Een bewezen pad van 0-meting naar live inzicht in de zichtbaarheid van jouw bedrijf."
              />
            </div>
      ...
      <section className="py-20 px-6 bg-white border-y border-black/5">
        <div className="max-w-7xl mx-auto">
          <SectionHeader
            ...
            description="Van Search Console en Analytics tot SE Ranking en LLM Pulse. We combineren de beste tools voor klassieke SEO, advertenties én AI-zichtbaarheid."
            align="center"
            className="mb-12"
          />
