...
export const Route = createFileRoute("/_site/kennis")({
  head: () => ({
    meta: [
      { title: "Kenniscentrum — Wat is GEO? | Expose Your Brand" },
      ...
      { property: "og:description", content: "Pillar page met alles over GEO, AI search en moderne SEO." },
      { property: "og:url", content: "/kennis" },
    ],
    links: [{ rel: "canonical", href: "/kennis" }],
  }),
  component: KennisLayout,
});

function KennisLayout() {
  const matchRoute = useMatchRoute();
  if (!matchRoute({ to: "/kennis" })) return <Outlet />;
  ...
  return (
    <>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto prose-section">
          <SectionHeader
            eyebrow="Definitie"
            title="Wat is GEO?"
