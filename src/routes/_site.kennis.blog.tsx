...
function BlogPage() {
  return (
    <>
      <PageHero eyebrow="Blog" title={<>Scherpe inzichten over <span className="text-molten italic">AI search.</span></>} description="Praktijk, geen theorie. Wat we leren van honderden GEO-trajecten, vertaald naar artikelen." />
